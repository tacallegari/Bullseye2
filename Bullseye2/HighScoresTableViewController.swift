...
//  Bullseye2
//
//  Created by Tahlia Callegari on 9/6/20.
...
class HighScoresTableViewController: UITableViewController, EditHighScoreViewControllerDelegate{
    ...
    //Mark:- Edit High Score ViewCtonroller Delegates
    func editHighScoreViewControllerDidCancel(_ controller: EditHighScoreViewController) {
        navigationController?.popViewController(animated: true)
    }
    func editHighScoreViewController(_controller: EditHighScoreViewController, didFinishEditing item: HighScoreItem) {
        //1
